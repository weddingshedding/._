...
form.addEventListener('submit', (e) => {
  ...
  const text = `Hello Wedding Shedding,%0AName: ${encodeURIComponent(name)}%0APhone: ${encodeURIComponent(phone)}%0AEvent Date: ${encodeURIComponent(eventDate)}%0AEvent Type: ${encodeURIComponent(eventType)}%0AVenue / City: ${encodeURIComponent(venue)}%0ADetails: ${encodeURIComponent(message)}`;
